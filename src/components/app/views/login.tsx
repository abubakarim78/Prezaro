    ...
    <div className="relative flex min-h-dvh flex-col items-center justify-center overflow-hidden bg-background px-4 py-10">
      ...
      >
        ...
        <div className="mt-7 rounded-2xl border bg-card p-6 shadow-sm">
          {/* Mode segmented tabs: Institutional Sign In vs Access Code */}
          <div className="mb-5 grid grid-cols-2 gap-1 rounded-xl bg-muted/60 p-1 text-xs font-semibold">
            <button
              type="button"
          ...
          <AnimatePresence mode="wait" initial={false}>
            <motion.div
              key={mode}
              initial={{ opacity: 0, x: mode === 'code' ? 16 : -16 }}
              animate={{ opacity: 1, x: 0 }}
              exit={{ opacity: 0, x: mode === 'code' ? -16 : 16 }}
          ...
          <div className="mt-5 border-t pt-4 text-center text-xs space-y-1.5">
            {mode === 'code' ? (
              ...
              <>
                ...
                <p className="text-[11px] text-muted-foreground/70">
                  New lecturer accounts are authorized exclusively through departmental access codes.
                </p>
              </>
            )}
          </div>
